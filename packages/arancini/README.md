...
```ts
// optional: opt component instances into being object pooled by arancini
@objectPooled() 
...
You can use `defineObjectComponent` to create a object component definition.
...
```ts
import { defineObjectComponent } from 'arancini'
import { Object3D } from 'three'

const Object3DComponent = defineObjectComponent<Object3D>()
...
You can use `defineTagComponent` to define a tag component. Tag components are useful for components that don't need to store any data.

```ts
import { defineTagComponent } from 'arancini'

const PlayerComponent = defineTagComponent()
